...
def man_render_image(camera_params_tuple,obj, stepsize, image_path='/home/usr/Desktop/DataSet', reso_tuple= [448,448], n = 0):
...
for i in range(start, end):
    ...
    bpy.ops.import_scene.obj(filepath=obj[i])
    #print('OBJ ')
    #print(obj[i])
    output_folder = obj[i].strip('/model.obj')
    output_folder = output_folder + '/rendering'
    output_folder = output_folder.strip('home/ndpmedina')
    ...
    for r in range(views):
        ...
        #print(r)
        man_render_image(camera_params_tuple, obj[i], da, output_folder, reso_tuple, r)
